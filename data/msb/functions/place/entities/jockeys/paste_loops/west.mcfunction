...
#The reason I use 'east' in the 'west' function is because east was originally intended for copying, and this is the opposite transformation.
#This function rotates the coordinates by 90 degrees clockwise
function msb:calc/entity_pos/east
...
execute if data storage msb:block data.entities.jockeys[0] run function msb:place/entities/jockeys/paste_loops/west