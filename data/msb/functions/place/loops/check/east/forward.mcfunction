#Callers:
# -msb:place/loops/check/east/left
...
execute if score shift_z msb.vol matches 0.. if score blocked msb.return matches 0 positioned ~1 ~ ~ run function msb:place/loops/check/east/forward