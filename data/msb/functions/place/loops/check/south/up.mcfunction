...
function msb:place/loops/check/south/left

execute if score shift_y msb.vol matches 0.. if score blocked msb.return matches 0 positioned ~ ~1 ~ run function msb:place/loops/check/south/up