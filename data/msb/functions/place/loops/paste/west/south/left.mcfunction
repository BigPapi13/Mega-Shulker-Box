...
function msb:place/loops/paste/west/south/forward
execute if score shift_x msb.vol matches 0.. positioned ~ ~ ~1 run function msb:place/loops/paste/west/south/left