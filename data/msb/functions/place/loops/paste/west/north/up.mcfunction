...
function msb:place/loops/paste/west/north/left
execute if score shift_y msb.vol matches 0.. positioned ~ ~1 ~ run function msb:place/loops/paste/west/north/up