...
execute unless block ~ ~ ~ minecraft:furnace{Items:[{Slot:0b,id:"minecraft:stick",tag:{msb:{initialized:0b}}}]} run function msb:search/block/paste/south/paste
function msb:place/loops/paste/paste_block_data

execute if score shift_z msb.vol matches 0.. positioned ~ ~ ~1 run function msb:place/loops/paste/south/forward