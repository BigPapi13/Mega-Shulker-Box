...
function msb:place/loops/paste/south/south/left
execute if score shift_y msb.vol matches 0.. positioned ~ ~1 ~ run function msb:place/loops/paste/south/south/up