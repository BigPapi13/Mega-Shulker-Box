...
function msb:place/loops/paste/north/south/left
execute if score shift_y msb.vol matches 0.. positioned ~ ~1 ~ run function msb:place/loops/paste/north/south/up