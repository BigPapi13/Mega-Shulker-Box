...
function msb:place/loops/paste/north/west/forward
execute if score shift_x msb.vol matches 0.. positioned ~-1 ~ ~ run function msb:place/loops/paste/north/west/left