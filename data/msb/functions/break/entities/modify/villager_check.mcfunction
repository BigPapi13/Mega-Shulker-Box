...
execute if score rotate.x msb.pos >= lower_x msb.pos if score rotate.x msb.pos <= upper_x msb.pos if score rotate.y msb.pos >= lower_y msb.pos if score rotate.y msb.pos <= upper_y msb.pos if score rotate.z msb.pos >= lower_z msb.pos if score rotate.z msb.pos <= upper_z msb.pos run function msb:break/entities/modify/villager